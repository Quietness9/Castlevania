...
public class InventorySlotCtr : SlotCtr, IPointerDownHandler, IPointerEnterHandler, IPointerExitHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        MenuCtr.Instance.CharacterUI.EquipWeapons(InventoryItemData);
    }
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        MenuCtr.Instance.ItemTip.ShowTipContent(InventoryItemData.ItemData,true);
    }
    ...
    {
        MenuCtr.Instance.ItemTip.HideTipContent();
    }
}
