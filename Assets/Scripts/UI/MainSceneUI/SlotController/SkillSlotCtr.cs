...
public class SkillSlotCtr : MonoBehaviour,IPointerEnterHandler,IPointerExitHandler,ISaveManager
{
    ...
    [SerializeField] SkillSlotCtr[] _unLockSlots;
    [SerializeField] SkillSlotCtr[] _lockSlots;
    ...
    private void IsUnLockSlot()
    {
        ...
        if (GlobalReferencesMgr.Instance.GamePlayer.HaveEnoughMoney(_skillPrice,_skillSoul) == false)
            return;
    ...
    {
        MenuCtr.Instance.SkillTip.ShowTip(_slotName+": "+_skillDescription);
        ...
        //MenuCtr.Instance.SkillTip.transform.position=new Vector3(mousePosition.x+offsetX,mousePosition.y+offsetY, 0);
        
    }

    public void OnPointerExit(PointerEventData eventData)
    {
        MenuCtr.Instance.SkillTip.HideTip();
    }
