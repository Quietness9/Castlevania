...
public class AttributeSlotCtr : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private void Start()
    {
        _playerAttribute = GlobalReferencesMgr.Instance.GamePlayer.Attribute as PlayerAttribute;
    ...
    {
        MenuCtr.Instance.AttributeTip.ShowTip(_attributeDescription);
    }
    ...
    {
        MenuCtr.Instance.AttributeTip.HideTip();
    }
}
