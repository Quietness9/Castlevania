...
public class CraftUlCtr : MonoBehaviour
{
    ...
    {
        _materialSlots=_materialSlotParent.GetComponentsInChildren<CraftSlotCtr>();
    ...
    public void MakeEquipment()
    {
        ...
        {
            GameObject itemObj = GlobalReferencesMgr.Instance.GetPrefab("Item");
            if (itemObj != null)
            {
