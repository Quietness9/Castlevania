...
public class MenuCtr : MonoSingleton<MenuCtr>
{
    [Header("提示UI")]
    public ItemTipCtr ItemTip;
    public TipCtr AttributeTip;
    public TipCtr SkillTip;

    [Header("主要角色面板UI")]
    public CharacterUICtr CharacterUI;
    public CraftUlCtr CraftUI;
