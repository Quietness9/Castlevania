...
public class CharacterUICtr : MonoBehaviour
{
    [Header("武器栏UI")]
    ...
    EquipmentSlotCtr[] _equipmentSlotControllers;
    ...
    public void InitCharacterUI()
    {
        ...
        _equipmentSlotControllers = _equipmentMenuSlotParent.GetComponentsInChildren<EquipmentSlotCtr>();
        ...
        for (int i = 0; i < _equipmentMenuSlotParent.childCount; i++)
        {
            ...
            if (_equipmentSlotControllers[i].InventoryItemData!= null&& _equipmentSlotControllers[i].InventoryItemData.ItemData!=null)
            {
                ...
                if (i == _equipmentMenuSlotParent.childCount - 1)
                {
                    ...
                    InGameUICtr.Instance.SetFlaskImageData(equipmentItemData.ShowIcon, equipmentItemData.Cooldown);
                }
            }
            else
            {
    ...
    private void EquipWeaponHelp(int index, InventoryItem inventoryItem, EquipmentItemData equipmentItemData)
    {
        ...
        GlobalReferencesMgr.Instance.GamePlayer.Attribute.AddEquipmentModifier(equipmentItemData);
